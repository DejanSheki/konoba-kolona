...
<body>
    <header>
        <div>
            <h1>Zapošljavamo!</h1>
            <p>Traže se novi članovi tima za nadolazeću sezonu 2023!</p>
        </div>
        <div>
    ...
    <main>
        <section class="positions">
            ...
            <div class="open-positions">
                ...
                <h5>Konobar m/ž</h5>
                <h5>Pomoćni kuhar u toploj kuhinji m/ž</h5>
                <h5>Pomoćni kuhar u hladnoj kuhinji m/ž</h5>
            </div>
        </section>
        <section class="form">
            <h2>Prijavite se za neku od pozicija</h2>
            <form enctype="multipart/form-data" method="POST" action="">
                <input type="text" name="sender_name" placeholder="Ime" required />
                <input type="text" name="sender_lastname" placeholder="Prezime" required />
                <input type="text" name="birth_date" placeholder="Datum rodjenja" onfocus="(this.type = 'date')"
                    required />
                <input type="tel" name="phone" placeholder="Telefon" required />
                <input type="email" name="sender_email" placeholder="Email" required />
                <p>Pozicija za koju se prijavljujete</p>
                <label for="waiter">
