...
<head>
    ...
    <title>Konoba Kolona | Cavtat | Contact</title>
			...
			<div class="contcontact">
				<div id="reservation">				  			
					<div class="reservation">
						<div class="h2"><h2>Reservation</h2></div>   					
							<h4 class="sent-notification"></h4>							
						<form  class="form-class" id="myForm" >			
							<div class="form">
								<div class="input">
									<input type="text"  class="formcontrol" id="name" name="name"  placeholder="Your name" required>
								</div>
							</div>
							<div class="form">
								<div class="input">
									<input type="email"  class="formcontrol" id="email"  placeholder="Your email address" required>
								</div>
							</div>
							<div class="form">
								<div class="input">
									<input type="text"  class="formcontrol" id="person" pattern="\d+" placeholder="Number of person" required>
								</div>
							</div>
							<div class="form">
								<div class="input">
								<label for="date">Date and time</label>
								<input type="text" id="dateandtime" name="date" class="formcontrol" required>
									<script>$(function(){
							...
							<div class="form">
								<div class="input">
									<textarea id="message" class="formcontrol"  rows="6" maxlength="3000" placeholder="Your message"></textarea>
								</div>
							</div>
							<div class="form">
								<button type="button" onclick="sendEmail()" value="Send an Email" class="btn">Send Message</button>
							</div>
						</form>
					</div>
				</div>
