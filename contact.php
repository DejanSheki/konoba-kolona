...
<head>
    ...
    <meta property="og:url" content="https://konobakolona.com/contact">
    ...
    <script type="application/ld+json">
    {
      ...
      "url" : "https://konobakolona.com/contact",
      "priceRange":"$$"
    }
    </script>
				...
				<div id="reservation">				  			
					<div class="reservation">
						...
						<form  class="form-class" id="myForm" >			
							...
							<div class="form">
								<button type="button" onclick="sendEmail()" value="Send an Email" class="btn">Send</button>
							</div>
			...
			<div class="contcontact">
				<div id="reservation">
					<div class="adress">
						...
						<i class="far fa-clock"></i><p>Mon - Sun  &nbsp <span style="color:rgb(233, 45, 45); font-weight:bold">Closed</span></p>
